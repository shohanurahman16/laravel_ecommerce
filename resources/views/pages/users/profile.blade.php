    ...
    <div class="container">
        <div class="card-body mb-5">
            @if(Session::has('updated_user'))
                <h2 class="bg-success">{{Session('updated_user')}}</h2>
                @endif
            <form method="POST" action="{{ route('user.profile.update') }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <textarea id="shipping_address" class="form-control{{ $errors->has('shipping_address') ? ' is-invalid' : '' }}" name="shipping_address" rows="4" autofocus>{{$user->shipping_address }}</textarea>
